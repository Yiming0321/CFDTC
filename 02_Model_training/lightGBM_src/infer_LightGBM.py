...
def inference(model_path: str,
    ...
    output_file = os.path.join(output_dir, f"LightGBM_result_{timestamp}.xlsx")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", "-o", default="./output", help="Folder where prediction file will be saved")
